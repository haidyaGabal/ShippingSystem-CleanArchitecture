...
namespace BL.DTOs
{
    public class UserReceiverDTO : BaseDTOs

    {
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Receiver name is required")]
        [StringLength(100, MinimumLength = 1, ErrorMessage = "Receiver name must be between 1 and 100 characters")]
        [RegularExpression(@"^[a-zA-Z\s\-'.]+$",
            ErrorMessage = "Receiver name can only contain letters, spaces, hyphens, apostrophes, and periods")]
